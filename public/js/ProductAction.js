...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (productSearch && categoryFilter && productsTableBody) {
        ...
        if (filterButton) {
            ...
            // Insert status filter before the filter button
            filterButton.insertAdjacentHTML('beforebegin', statusFilterHtml);
        ...
        clearFiltersButton.className = 'btn btn-outline-secondary ms-2';
        clearFiltersButton.innerHTML = '<i class="bi bi-x-circle"></i> Clear';
        ...
        // Add clear button after filter button
        if (filterButton) {
            filterButton.parentNode.appendChild(clearFiltersButton);
        }
        
        // Add search placeholder text to indicate searchable fields
