...
// CUSTOM ALERT MODAL - REPLACED SWEETALERT
    ...
    const modalHTML = `
        <div id="customAlert" class="custom-alert-overlay">
            <div class="custom-alert-box">
                ...
                <h3 class="alert-title">Login Required</h3>
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    document.querySelectorAll(".add-to-cart").forEach(btn => {
        btn.addEventListener("click", e => {
            ...
            showCustomAlert(`You need to login first to add "${productName}" to your cart.`);
        });
    });
    ...
    if (cartBtn) {
        cartBtn.addEventListener("click", e => {
            e.preventDefault();
            showCustomAlert('You need to login first to view your cart.');
        });
    }
});

// Add CSS styles for custom alert
const alertStyles = `
<style>
